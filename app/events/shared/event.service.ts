 ...
 * in your class.
 * 
 * Services needs to be declared on the "providers" declaration of your module, so Angular knows how to inject it
 * in your component classes when you specify the "service" on your "Component" class. 
 */
@Injectable()
